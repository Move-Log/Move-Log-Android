...
class GetWeekNewsRecordUseCase @Inject constructor(
    private val repository: NewsRepository
) {

    suspend operator fun invoke(page: Int = 0): Result<Pageable<NewsContent>> {
        return repository.getWeekNewsRecords(page)
    }
}